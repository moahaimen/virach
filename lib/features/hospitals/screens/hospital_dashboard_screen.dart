...
class ResponsiveHospitalDashboard extends StatefulWidget {
  ...
  const ResponsiveHospitalDashboard({
    Key? key,
  ...
  @override
  _ResponsiveHospitalDashboardState createState() =>
      _ResponsiveHospitalDashboardState();
}

class _ResponsiveHospitalDashboardState extends State<ResponsiveHospitalDashboard> {
...
// after you finish reading nurseId:
  Future<void> _loadHospitalId() async {
    ...
    setState(() {
      hospitalId = prefs.getString("labrotary_id") ?? widget.hospitalId;
    });

    debugPrint("Loaded Hospital ID: $hospitalId");
  ...
  Future<void> _loadNotifications({bool silent = false}) async {
    ...
    try {
      ...
      final fetchedNotifications = await provider.fetchNotifications(hospitalId);
      setState(() {
