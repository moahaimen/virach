...
class ResponsiveHospitalDashboard extends StatefulWidget {
  ...
  @override
  State<ResponsiveHospitalDashboard> createState() => _ResponsiveHospitalDashboardState();
}
...
class _ResponsiveHospitalDashboardState extends State<ResponsiveHospitalDashboard> {
  ...
  Future<void> _bootstrap() async {
    ...
    _hospId = prefs.getString("hospital_id") ?? prefs.getString("labrotary_id") ?? widget.hospitalId;
  ...
  Future<void> _loadNotifications({bool silent = false}) async {
    ...
    try {
      ...
      final fetched = await provider.fetchNotifications(_hospId);
