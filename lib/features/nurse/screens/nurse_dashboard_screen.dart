...
class ResponsiveNurseDashboard extends StatefulWidget {
  ...
  const ResponsiveNurseDashboard({
    Key? key,
  ...
  @override
  _ResponsiveNurseDashboardState createState() =>
      _ResponsiveNurseDashboardState();
}

class _ResponsiveNurseDashboardState extends State<ResponsiveNurseDashboard> {
...
// after you finish reading nurseId:
  Future<void> _loadNurseId() async {
    ...
    setState(() {
      nurseId = prefs.getString("doctor_id") ?? widget.nurseId;
    });

    debugPrint("Loaded Doctor ID: $nurseId");
  ...
  Future<void> _loadNotifications({bool silent = false}) async {
    ...
    try {
      ...
      final fetchedNotifications = await provider.fetchNotifications(nurseId);
      setState(() {
