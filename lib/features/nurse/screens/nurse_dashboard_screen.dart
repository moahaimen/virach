...
class ResponsiveNurseDashboard extends StatefulWidget {
  ...
  @override
  State<ResponsiveNurseDashboard> createState() => _ResponsiveNurseDashboardState();
}
...
class _ResponsiveNurseDashboardState extends State<ResponsiveNurseDashboard> {
  ...
  Future<void> _bootstrap() async {
    ...
    _nurseId = prefs.getString("nurse_id") ?? prefs.getString("doctor_id") ?? widget.nurseId;
  ...
  Future<void> _loadNotifications({bool silent = false}) async {
    ...
    try {
      ...
      final fetched = await provider.fetchNotifications(_nurseId);
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('لوحة تحكم التمريض'),
          actions: [
            IconButton(
