...
class ResponsiveLabrotaryDashboard extends StatefulWidget {
  ...
  @override
  State<ResponsiveLabrotaryDashboard> createState() => _ResponsiveLabrotaryDashboardState();
}
...
class _ResponsiveLabrotaryDashboardState extends State<ResponsiveLabrotaryDashboard> {
  ...
  Future<void> _bootstrap() async {
    ...
    _labId = prefs.getString("labrotary_id") ?? widget.labrotaryId;
  ...
  Future<void> _loadNotifications({bool silent = false}) async {
    ...
    try {
      ...
      final fetched = await provider.fetchNotifications(_labId);
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('لوحة تحكم المختبر'),
          actions: [
            IconButton(
