...
import '../features/widgets/hsp_today_appointment_filter_row.dart';
import '../features/widgets/hsp_today_appointment_search_bar.dart';
import '../features/widgets/hsp_today_apponitment_header_row.dart';
import '../features/widgets/hsp_today_apponitment_pagination_controls.dart';
import '../features/widgets/hsp_today_apponitment_row.dart';

class BaseTodayAppointments extends StatefulWidget {
  final String userType, userId, hspId, userName;
  const BaseTodayAppointments({
    super.key,
  ...
  @override
  State<BaseTodayAppointments> createState() => _BaseTodayAppointmentsState();
}

class _BaseTodayAppointmentsState extends State<BaseTodayAppointments> {
  ...
  @override
  void didUpdateWidget(covariant BaseTodayAppointments oldWidget) {
    super.didUpdateWidget(oldWidget);
    if (oldWidget.hspId != widget.hspId && widget.hspId.isNotEmpty) {
